...
export class UserDetailInfo {
    ...
    @Column({name: 'real_name', type: 'varchar', width: 20})
    ...
    @Column({name: 'self_sign', type: 'varchar', width: 50, nullable: true})
    selfSign: string | null = null;
    
    @Column({type: 'varchar', width: 20, nullable: true})
    company: string | null = null;

    @Column({name: 'job_title', type: 'varchar', width: 20, nullable: true})
    ...
    @Column({name: 'person_info', type: 'varchar', width: 50, nullable: true})
